...
# -*- coding: utf-8 -*-
#
# exosip2ctypes documentation build configuration file, created by
...
htmlhelp_basename = 'exosip2ctypesdoc'
...
latex_documents = [
    (master_doc, 'exosip2ctypes.tex', 'exosip2ctypes Documentation',
     'Liu Xue Yan', 'manual'),
]
...
man_pages = [
    (master_doc, 'exosip2ctypes', 'exosip2ctypes Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'exosip2ctypes', 'exosip2ctypes Documentation',
     author, 'exosip2ctypes', 'One line description of project.',
     'Miscellaneous'),
]
